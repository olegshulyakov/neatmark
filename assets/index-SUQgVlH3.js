...
const BookmarkProvider = ({ children }) => {
  ...
  reactExports.useEffect(() => {
    fetch("data/bookmarks.html").then((response) => response.text()).then((html) => parseBookmarks(html)).then((data) => setBookmarks(data));
  }, []);
    ...
    for (const line of lines) {
      ...
      if (trimmed.startsWith("<DT><H3")) {
        ...
        if (linkMatch && linkMatch[1]) {
          const attributes2 = parseAttributes(linkMatch[2] || "");
  ...
  const parseAttributes = (attrText) => {
    const attributes = /* @__PURE__ */ Object.create({});
...
const SearchContext = reactExports.createContext(void 0);
const SearchProvider = ({ children }) => {
  const { bookmarks } = reactExports.useContext(BookmarkContext);
      ...
      return items.reduce((acc, item) => {
        if (item.type === "folder") {
          ...
          if (filteredChildren.length > 0) {
            filteredChildren.map((item2) => acc.push(item2));
          }
        } else if (item.title.toLowerCase().includes(searchQuery.toLowerCase()) || item.url.toLowerCase().includes(searchQuery.toLowerCase())) {
          acc.push(item);
        }
        return acc;
      }, []);
    };
    const getFolderItems = (folderTitle) => {
      if (!folderTitle) return bookmarks;
      const findFolder = (folders, title) => {
...
const ThemeProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeContext.Provider, { value: { theme, setTheme, isSidebarCollapsed, hideSidebar, showSidebar }, children });
};
const Logo = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app-logo", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "app-logo-img", src: "assets/logo.svg", alt: "NeatMark" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "app-logo-name", href: "", children: "Neatmark" })
  ] });
};
const NavbarLayout = ({ children }) => {
  const { showSidebar } = reactExports.useContext(ThemeContext);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "navbar", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Show Sidebar", onClick: showSidebar, className: "navbar-toggle-btn" }),
...
const FolderRow = ({ folder }) => {
  const { selectedFolder, setSelectedFolder } = reactExports.useContext(SearchContext);
  const { hideSidebar } = reactExports.useContext(ThemeContext);
  const handleFolderClick = (folder2) => {
    setSelectedFolder(folder2.title);
    hideSidebar();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: `folder ${selectedFolder === folder.title ? "selected" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "title", onClick: () => handleFolderClick(folder), children: [
...
const FolderTree = () => {
  const { bookmarks } = reactExports.useContext(BookmarkContext);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "folder-tree", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: bookmarks.map((item) => item.type === "folder" && /* @__PURE__ */ jsxRuntimeExports.jsx(FolderRow, { folder: item }, item.title)) }) });
};
const SearchBar = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "searchbar", children: [
    ...
    input && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Clear", onClick: handleClear })
  ] });
};
const ThemeButton = ({ title }) => {
  const { theme, setTheme } = reactExports.useContext(ThemeContext);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${title}-icon` })
    }
  );
};
const ThemeToggle = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "theme-toggle", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeButton, { title: "system" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeButton, { title: "light" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeButton, { title: "dark" })
  ] });
};
const SidebarLayout = ({ children }) => {
  const { isSidebarCollapsed: isCollapsed, hideSidebar } = reactExports.useContext(ThemeContext);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.aside,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { title: "Hide Sidebar", onClick: hideSidebar, className: "sidebar-toggle-btn" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, {}),
...
const FolderCard = ({ folder }) => {
  const { setSelectedFolder } = reactExports.useContext(SearchContext);
  const handleFolderClick = (folder2) => {
    setSelectedFolder(folder2.title);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "folder-card", onClick: () => handleFolderClick(folder), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "icon" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "title", children: folder.title })
  ] }, folder.title);
};
const BookmarkCard = ({ bookmark }) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: bookmark.url, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bookmark-card", children: [
  !bookmark.icon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "icon" }),
  bookmark.icon && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: bookmark.icon, alt: bookmark.title, className: "icon-image" }),
  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "info", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "title", children: bookmark.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "url", children: bookmark.url })
  ] })
] }) }, bookmark.url);
const CardGrid = () => {
  const { filteredBookmarks } = reactExports.useContext(SearchContext);
...
const App = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SearchProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavbarLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "main-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardGrid, {}) }) }) }) }) }) }) });
};
